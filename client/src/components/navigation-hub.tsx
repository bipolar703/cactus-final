      ...
      >
        ...
        <div className="mb-16">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <p className={`text-lg sm:text-xl lg:text-2xl font-light text-white/90 mb-3 text-shadow-soft ${
          ...
          {navItems.map((item, index) => (
            ...
            >
              ...
              <div className="relative text-center">
                ...
                <h3 className={`text-white font-semibold text-lg mb-2 text-shadow-soft ${
                  language === 'ar' ? 'font-arabic' : 'font-poppins'
                }`}>
                  {t(item.titleKey)}
                </h3>
                ...
                <p className={`text-white/70 text-sm ${
                  ...
                  {language === 'ar' 
                    ? (item.id === 'about' ? 'قصتنا' : 
                       ...
                       item.id === 'portfolio' ? 'مشاريعنا' : 'راسلنا')
                    : item.descKey
                  }
                </p>
              </div>
