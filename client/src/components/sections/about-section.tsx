    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          >
            <div className="w-24 h-1 bg-gradient-to-r from-jaded-green-600 to-jaded-green-400 rounded-full mx-auto mb-4"></div>
          </motion.div>
          ...
          <p
            className={`text-2xl text-white/90 max-w-4xl mx-auto leading-relaxed font-light ${
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="glass-strong rounded-3xl p-10 backdrop-blur-xl border border-white/10 hover:border-jaded-green-600/30 transition-all duration-500 hover-glow">
                <div className="flex items-start space-x-6">
                  <div className="flex-shrink-0">
                    <div className="w-20 h-20 bg-gradient-to-br from-jaded-green-600 to-jaded-green-400 rounded-2xl flex items-center justify-center group-hover:scale-110 group-hover:rotate-3 transition-all duration-300 shadow-xl">
                  ...
                  <div className="flex-1">
                    <h3
                      className={`text-2xl font-bold text-white mb-4 group-hover:text-jaded-green-400 transition-colors duration-300 ${
                        language === 'ar' ? 'font-arabic' : 'font-poppins'
                      }`}
                    >
                      {feature.title}
                ...
                {/* Hover line effect */}
                <div className="h-1 bg-gradient-to-r from-jaded-green-600 to-jaded-green-400 rounded-full mt-6 scale-x-0 group-hover:scale-x-100 transition-transform duration-500 origin-left"></div>
              </div>
            </motion.div>
          ))}
        </div>
