export const translations = {
  en: {
    ...
    packageDealsText:
      'Save up to 25% when you bundle multiple services. Contact us for custom pricing based on your specific needs.',
  ...
  ar: {
    ...
    ourVision: 'رؤيتنا',
    missionText:
      'في مجموعة كاكتوس الإعلامية، نتخصص في إنشاء محتوى بصري مقنع يحكي قصتك. مع أكثر من عقد من الخبرة في صناعة الإعلام، نجمع بين الإبداع والتكنولوجيا المتطورة لتقديم نتائج استثنائية.',
    visionText:
      'نتصور عالماً حيث لكل علامة تجارية هوية بصرية قوية تتردد صداها مع جمهورها. هدفنا هو أن نكون شركة الإنتاج الإعلامي الرائدة في المنطقة، ووضع معايير جديدة للجودة والابتكار.',
    ...
    packageDealsText:
      'وفر حتى 25% عندما تجمع عدة خدمات معاً. اتصل بنا للحصول على أسعار مخصصة حسب احتياجاتك المحددة.',
