    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-jaded-green-50">
        <div className="text-center p-8">
          ...
          <Link href="/services" className="text-jaded-green-600 hover:text-jaded-green-700 font-semibold">
          ...
          <div className="max-w-6xl mx-auto px-6 sm:px-8">
              ...
              >
                <div className="mb-6">
                  <div className="w-24 h-24 bg-gradient-to-br from-jaded-green-100 to-jaded-green-50 rounded-3xl flex items-center justify-center mb-6">
                    <img src={service.icon} alt={service.title[language]} className="w-16 h-16" />
                  </div>
                </div>

                <h1 className={`text-4xl md:text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-gray-900 via-jaded-green-800 to-gray-900 bg-clip-text text-transparent ${
            ...
            >
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  { icon: Users, number: '100+', label: language === 'ar' ? 'عميل راضٍ' : 'Happy Clients' },
                  { icon: Award, number: '50+', label: language === 'ar' ? 'مشروع مكتمل' : 'Projects Completed' },
                  { icon: Star, number: '5.0', label: language === 'ar' ? 'تقييم العملاء' : 'Client Rating' }
                ].map((stat, index) => (
                  <motion.div
                    key={index}
                    whileHover={{ scale: 1.05 }}
