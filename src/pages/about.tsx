...
export default function About() {
  ...
  // SEO and meta data
  const pageTitle = language === 'ar' ? 'من نحن | مجموعة كاكتوس الإعلامية' : 'About Us | Cactus Media Group';
  ...
  return (
    <>
      ...
      <meta name="keywords" content={language === 'ar' ? 'من نحن, فريق العمل, قيم الشركة, رؤية, رسالة' : 'about us, team, company values, vision, mission'} />
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <p className={`text-jaded-green-600 font-semibold mb-4 ${
                    language === 'ar' ? 'font-arabic' : ''
                  }`}>
          ...
          >
            <div className="bg-gradient-to-r from-jaded-green-600 to-jaded-green-500 rounded-3xl p-12 text-white shadow-2xl">
              <h3 className={`text-3xl md:text-4xl font-bold mb-6 ${
                ...
                {language === 'ar' ? 'جاهز للعمل معنا؟' : 'Ready to Work With Us?'}
              </h3>
