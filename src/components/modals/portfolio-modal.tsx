  ...
  const portfolioItems = [
    {
      ...
      description:
        language === 'ar'
          ? 'بنك الراجحي - حملة العلامة التجارية'
          : 'Al-Rajhi Bank - Brand Campaign',
      icon: Play,
    },
    {
      image:
        'https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=300',
      title: t('fashionPhotography'),
      description:
        language === 'ar' ? 'مجموعة العلامة التجارية الفاخرة' : 'Luxury Brand Collection',
      icon: CameraIcon,
    },
    {
      image:
    ...
    {
      image:
        'https://images.unsplash.com/photo-1551288049-bebda4e38f71?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=300',
    ...
    {
      image:
        'https://images.unsplash.com/photo-1485846234645-a62644f84728?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&h=300',
