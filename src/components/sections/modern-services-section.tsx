...
export function ModernServicesSection() {
  ...
  const aiService = services.find(s => s.slug === 'ai-integration-automation');
    ...
    >
      ...
      <div className="max-w-7xl mx-auto relative">
          ...
          <div className="mb-12 w-full flex flex-col md:flex-row items-center bg-jaded-green-700 rounded-3xl shadow-2xl p-8 md:p-12 border-2 border-jaded-green-400/40 relative overflow-hidden">
            ...
            <div className="flex-shrink-0 mb-6 md:mb-0 md:mr-10 flex flex-col items-center">
              <div className="relative">
                <img src="/assets/animated/services/ai.gif" alt={aiService.title[language]} className="w-24 h-24 md:w-32 md:h-32 rounded-2xl shadow-lg border-4 border-white/20" />
              </div>
            </div>
            <div className="flex-1 text-center">
              ...
              <div className="flex flex-wrap gap-3 justify-center mb-4">
                {aiService.features[language].map((feature, i) => (
                  <span key={i} className="inline-block bg-white/10 text-white px-4 py-2 rounded-xl text-sm font-medium border border-white/20">
                    {feature}
                  </span>
                ))}
              </div>
              <div className="flex justify-center w-full">
                <a href="/services/ai-integration-automation" className="inline-block mt-2 bg-white text-jaded-green-700 font-bold py-3 px-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-lg">
        ...
        <div className="flex justify-center mt-16">
          <a href="/services" className="inline-block bg-gradient-to-r from-jaded-green-600 to-jaded-green-500 text-white font-bold py-4 px-10 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-lg">
            Show All Services
          </a>
        </div>
      </div>
