  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-gold-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '2s' }} />
      ...
      >
        ...
        >
          <motion.a
            href="/services"
            whileHover={{ scale: 1.05, boxShadow: '0 20px 40px rgba(0, 150, 125, 0.3)' }}
            whileTap={{ scale: 0.95 }}
          ...
          >
            ...
            {language === 'ar' ? 'اكتشف أعمالنا' : 'Discover Our Work'}
          </motion.a>
